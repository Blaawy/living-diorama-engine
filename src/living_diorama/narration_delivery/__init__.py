...
executed pixels -- never read a unit's sentence, never mutate its inputs, and
never call a model or a network service at runtime. The allocation policy is
fixed at review time, in ``delivery_spec``, and is part of this contract's
schema version.
